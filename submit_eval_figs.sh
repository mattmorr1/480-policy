...
ensure_scratch_link "adapters" "$ARTIFACT_ROOT/adapters"
ensure_scratch_link "rag_index" "$ARTIFACT_ROOT/rag_index"
ensure_scratch_link "results" "$ARTIFACT_ROOT/results"
